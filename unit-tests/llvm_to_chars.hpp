...
namespace to_chars_llvm_tests {

	template<typename v_type> struct test_basics : to_chars_test_base<v_type> {
		using to_chars_test_base<v_type>::test;
		using to_chars_test_base<v_type>::test_value;
	...
	template<typename v_type> struct test_signed : to_chars_test_base<v_type> {
		using to_chars_test_base<v_type>::test;
		using to_chars_test_base<v_type>::test_value;
