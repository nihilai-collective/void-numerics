...
namespace benchmarks {
	...
	template<typename benchmark_stage_type, bnch_swt::string_literal test_name_new, typename test_data_type, typename output_data_type, typename... test_types> auto execute_tests(
		uint64_t test_size, test_data_type& test_data, output_data_type& output_buffer, bnch_swt::internal::cache_clearer<bnch_swt::benchmark_types::cpu>& cclearer) {
		uint64_t output_buffer_index{};
		(execute_test<benchmark_stage_type, test_name_new, test_types>(test_size, test_data, output_buffer, output_buffer_index, cclearer), ...);
	}
	...
	auto run_one_test(bnch_swt::internal::cache_clearer<bnch_swt::benchmark_types::cpu>& cclearer) {
		static constexpr uint64_t total_values{ test_size };
		...
		execute_tests<benchmark_stage_type, test_name, test_data_type, output_data_type, test_types...>(test_size, test_data, output_buffer, cclearer);
	...
	static void mixed_digit_count(bnch_swt::internal::cache_clearer<bnch_swt::benchmark_types::cpu>& cclearer) {
		run_one_test<benchmark_stage_type, test_name, 100, total_iters_new, measured_iters, v_type, correctness_verifier, digit_generator_type, negative, test_types...>(cclearer);
		run_one_test<benchmark_stage_type, test_name, 1000, total_iters_new, measured_iters, v_type, correctness_verifier, digit_generator_type, negative, test_types...>(cclearer);
		run_one_test<benchmark_stage_type, test_name, 10000, total_iters_new, measured_iters, v_type, correctness_verifier, digit_generator_type, negative, test_types...>(cclearer);
	...
	struct digit_iterator {
		static auto impl(bnch_swt::internal::cache_clearer<bnch_swt::benchmark_types::cpu>& cclearer) {
	...
	auto test_function_impl(bnch_swt::internal::cache_clearer<bnch_swt::benchmark_types::cpu>& cclearer) {
		digit_iterator<benchmark_stage_type, "int8", total_iters, measured_iters, int8_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "uint8", total_iters, measured_iters, uint8_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "int16", total_iters, measured_iters, int16_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "uint16", total_iters, measured_iters, uint16_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "int32", total_iters, measured_iters, int32_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "uint32", total_iters, measured_iters, uint32_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "int64", total_iters, measured_iters, int64_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
		digit_iterator<benchmark_stage_type, "uint64", total_iters, measured_iters, uint64_t, correctness_verifier, digit_generator_type, test_types...>::impl(cclearer);
	}
	...
	struct tests {
		static void impl() {
			...
			bnch_swt::internal::cache_clearer<bnch_swt::benchmark_types::cpu> cclearer{};
			test_function_impl<bench_stage_type, stage_name, total_iters, measured_iters, correctness_verifier, digit_generator_type, test_types...>(cclearer);
